...
function Home() {
  ...
  const stats = [
    { id: 'happy-clients', number: "500+", label: "Happy Clients", icon: "😊" },
    { id: 'bookings-completed', number: "1000+", label: "Bookings Completed", icon: "✅" },
    { id: 'premium-facilities-count', number: "50+", label: "Premium Facilities", icon: "🏢" },
    { id: 'support-available', number: "24/7", label: "Support Available", icon: "💬" }
  ];

            ...
            {currentBookings.length === 0 ? (
              ...
              <div className="space-y-4">
                {currentBookings.map((booking) => {
                  ...
                  return (
                    <Card key={booking.bookingId} hover className="border-l-4 border-primary-600">
                      <Card.Body>

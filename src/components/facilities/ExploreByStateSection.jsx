...
const ExploreByStateSection = ({ facilities }) => {
    ...
    <section className="py-20 bg-white dark:bg-neutral-950">
      <div className="container-custom">
        ...
        <div className="text-left mb-12">
          ...
          <p className="text-xl text-left text-neutral-600 dark:text-neutral-400 max-w-2xl">
            Browse facilities organized by location
          </p>
        </div>
        ...
        {filteredFacilities.length > 0 ? (
          ...
          <div className="text-center py-16">
            ...
            <p className="text-xl text-neutral-600 dark:text-neutral-400">
              No facilities found in {selectedState}
            </p>
          </div>
        )}
      </div>
...
ExploreByStateSection.propTypes = {
...
export default ExploreByStateSection;